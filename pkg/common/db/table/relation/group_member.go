...
type GroupMemberModelInterface interface {
	...
	SearchMember(ctx context.Context, keyword string, groupID string, position int32, pagination pagination.Pagination) (total int64, groupList []*GroupMemberModel, err error)
